export default async function handler(req, res) {
  ...
  **Categories and Corresponding LLMs:**
  ...
  Reason for Selection: [Brief explanation of why this LLM was chosen based on the prompt and context.]`,
        ...
        // Extract the selected LLM from the analysis output
        ...
        switch (selectedLlm) {
          case 'ChatGPT':
            apiEndpoint = `http://localhost:3000/api/chatgpt`; // Use absolute URL
            break;
          case 'Claude':
            apiEndpoint = `http://localhost:3000/api/claude`; // Use absolute URL
            break;
          case 'Llama':
            apiEndpoint = `http://localhost:3000/api/llama`; // Use absolute URL
            break;
          default:
        ...
        // Step 3: Return the response with the chosen LLM
        res.status(200).json({
