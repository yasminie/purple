...
const Navbar = () => {
  return (
    <div className={cn("min-h-screen relative w-full max-w-[244px] pl-4 pr-6 pt-20")}>

        <div className="absolute top-5 left-0 pl-4 pr-6 w-full">
            <Link href={'/'} className="flex justify-between w-full items-center hover:bg-slate-800/80 rounded-lg p-3 transition-all">
...
function Timeline(props: Timeline){
    ...
    <div className="w-full flex flex-col">
        ...
        {props.timelines.map((d, i) => 
            ...
            <Link 
            key={i} 
            className={cn("p-2 group hover:bg-slate-800 rounded-lg transition-all text-sm w-full flex justify-between items-center ease-in-out", 
